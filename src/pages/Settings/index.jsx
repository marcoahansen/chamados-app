...
import { Avatar, Badge, Button, Grid, IconButton, Paper, TextField } from "@mui/material";
        ...
        <Grid item xs={12}>
          <Paper component="form" onSubmit={handleSubmit} sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
            <Box
              ...
              >
                <Avatar src={avatarUrl === null ? avatar : avatarUrl} sx={{ m: 1, bgcolor: 'primary.main', width:'120px', height:'120px' }}/>
